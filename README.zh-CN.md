...
| 需要什么 | |
|---|---|
| 操作系统 | Windows 10 / 11，**16:9 分辨率，缩放 100%**（真实对局验证过的是 1920×1080） |
| OBS Studio | 28 或更新 |
| 游戏设置 | 建议**无边框全屏** |
...
| 游戏分辨率 | 读取文字时使用的画面尺寸。卡片位置会自行跟随画面尺寸，因此任何 16:9 尺寸都能工作，其他比例会给出警告 |
...
- 坐标是在 1920×1080 下测得的，并会**按比例跟随**收到的画面尺寸。任何 16:9 尺寸都落在同一布局上，
  自测会把录制的画面改为 720p、900p、1440p 和 4K 来确认这一点。真实对局只在 1920×1080 下跑过。
  非 16:9 的画面会被 OBS 拉伸为 16:9 后送来，此时卡片是否仍对得上尚未验证。
